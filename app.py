...
if page == "01 · Питч":
    ...
    st.markdown("""
    <div class="tip-box">
    CeMAT — выставка про склад и производство. Значит чаще будут спрашивать про WMS, YL (двор)
    и TOS (терминал), а не про TMS (транспорт) — хотя TMS у вас самый готовый продукт.
    </div>
    """, unsafe_allow_html=True)
